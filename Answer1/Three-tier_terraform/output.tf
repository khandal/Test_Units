...
#   description = "The cluster primary security group ID crindiated by the EKS cluster on 1.14 or later. Referred to as 'Cluster security group' in the EKS console."
